...
class WeatherController: UICollectionViewController, UICollectionViewDelegateFlowLayout, UISearchBarDelegate
{
    ...
    private func setupNavigationBar()
    {
        ...
        navigationController?.navigationBar.largeTitleTextAttributes = [NSAttributedStringKey.foregroundColor : UIColor.rgb(red: 191, green: 48, blue: 48)]
        
        navigationController?.navigationBar.titleTextAttributes = [NSAttributedStringKey.foregroundColor : UIColor.rgb(red: 191, green: 48, blue: 48)]
    }
